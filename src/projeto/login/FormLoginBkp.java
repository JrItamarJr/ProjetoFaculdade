 ...
 * @author itamar
 */
public final class FormLoginBkp extends javax.swing.JFrame {
...
// este mesmo codido pode ser usado na tela FormPrincipal no Botao Logoff
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormLoginBkp.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormLoginBkp().setVisible(true);
            }
        });
    }
